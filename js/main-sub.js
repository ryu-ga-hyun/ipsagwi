...
// 셀렉션 구현 코드
document.addEventListener("DOMContentLoaded", function () {
  const selectItems = document.querySelectorAll(".select-plant li");
  const boxItems = document.querySelectorAll(".box-plant li");

  // 초기 상태 설정
  boxItems[0].classList.add("active");
...
$(function () {
  $('.favorite').click(function () {
    $(this).find('.favorite-img').AddClass('on')
  })
